...
├── register.html       # ទំព័រចុះឈ្មោះបង្កើតគណនីថ្មី
├── register-style.css  # ស្ទីលបន្ថែម និងការកំណត់ Font ខ្មែរសម្រាប់ទំព័រចុះឈ្មោះ
├── register-script.js # មុខងារផ្ទៀងផ្ទាត់ទិន្នន័យទម្រង់ចុះឈ្មោះ (Validation)
├── login.html          # ទំព័រចូលប្រើប្រាស់ប្រព័ន្ធ (Sign In Page)
├── login-style.css     # ស្ទីលបន្ថែម និងការកំណត់ Font ខ្មែរសម្រាប់ទំព័រចូលប្រើប្រាស់
├── login-script.js    # មុខងារផ្ទៀងផ្ទាត់ទិន្នន័យទម្រង់ចូលប្រើប្រាស់ (Validation)
├── style.css           # ស្ទីលបន្ថែម ចលនា (Animations) និងការកំណត់ Font ខ្មែរទំព័រដើម
